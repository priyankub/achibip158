...
ext_modules = [
    Extension(
        ...
        [
            ...
            "python-bindings/achibip158.cpp",
        ],
        include_dirs=[
...
setup(
    ...
    description="Achi BIP158 (wraps C++)",
    license="Apache License",
    python_requires=">=3.7",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    setup_requires=["pybind11>=2.5.0"],
    url="https://github.com/Achi-Coin/achibip158",
    ext_modules=ext_modules,
    cmdclass={"build_ext": BuildExt},
    zip_safe=False,
)
pranks@pranks-farmer:~/github/chia_forks/achibuild$ QA!ZS^C
pranks@pranks-farmer:~/github/chia_forks/achibuild$ cat achivdf/setup.py 
import os
import platform
import re
import shutil
...
if platform.system() == "Windows":
    setup(
        ...
        author="Sten Achiho",
        author_email="sten@achicoin.org",
        description="Achi vdf verification (wraps C++)",
        license="Apache License",
        python_requires=">=3.7",
        long_description=open("README.md").read(),
        long_description_content_type="text/markdown",
        build_requires=["pybind11"],
        url="https://github.com/Achi-Coin/achivdf",
        ext_modules=ext_modules,
        cmdclass={"build_ext": BuildExt},
        zip_safe=False,
    )
    ...
    setup(
        ...
        url="https://github.com/Achi-Coin/achivdf",
        setup_requires=["pybind11>=2.5.0"],
        ext_modules=[CMakeExtension("achivdf", "src")],
        cmdclass=dict(
            build_ext=CMakeBuild, install_hook=install_hook, build_hook=build_hook
        ),
        zip_safe=False,
    )
pranks@pranks-farmer:~/github/chia_forks/achibuild$ cat achibip158/setup.py
""" based on
    https://github.com/pybind/python_example/blob/master/setup.py
"""
from setuptools import setup, Extension
